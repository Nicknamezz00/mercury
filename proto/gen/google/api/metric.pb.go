...
type MetricDescriptor struct {
	...
	Labels []*LabelDescriptor `protobuf:"bytes,2,rep,name=labels,proto3" json:"labels,omitempty"`
	...
	LaunchStage LaunchStage `protobuf:"varint,12,opt,name=launch_stage,json=launchStage,proto3,enum=google.api.LaunchStage" json:"launch_stage,omitempty"`
...
func (x *MetricDescriptor) GetLaunchStage() LaunchStage {
	if x != nil {
...
type MetricDescriptor_MetricDescriptorMetadata struct {
	...
	LaunchStage LaunchStage `protobuf:"varint,1,opt,name=launch_stage,json=launchStage,proto3,enum=google.api.LaunchStage" json:"launch_stage,omitempty"`
...
// Deprecated: Marked as deprecated in google/api/metric.proto.
func (x *MetricDescriptor_MetricDescriptorMetadata) GetLaunchStage() LaunchStage {
	if x != nil {
		return x.LaunchStage
	}
	return LaunchStage_LAUNCH_STAGE_UNSPECIFIED
...
var file_google_api_metric_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x42, 0x9c, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
...
var file_google_api_metric_proto_goTypes = []interface{}{
	...
	(*LabelDescriptor)(nil),     // 6: google.api.LabelDescriptor
	(LaunchStage)(0),            // 7: google.api.LaunchStage
...
func file_google_api_metric_proto_init() {
	...
	file_google_api_label_proto_init()
