...
var file_api_v2_message_service_proto_rawDesc = []byte{
	...
	0x49, 0x43, 0x10, 0x03, 0x32, 0xfe, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_api_v2_message_service_proto_depIdxs = []int32{
	...
	2, // 4: mercury.api.v2.MessageService.ListMessages:input_type -> mercury.api.v2.ListMessagesRequest
	4, // 5: mercury.api.v2.MessageService.GetMessage:input_type -> mercury.api.v2.GetMessageRequest
	3, // 6: mercury.api.v2.MessageService.ListMessages:output_type -> mercury.api.v2.ListMessagesResponse
	5, // 7: mercury.api.v2.MessageService.GetMessage:output_type -> mercury.api.v2.GetMessageResponse
