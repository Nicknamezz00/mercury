...
export const Context = {
  ...
  fromJSON(object: any): Context {
    return { rules: Array.isArray(object?.rules) ? object.rules.map((e: any) => ContextRule.fromJSON(e)) : [] };
  },
  ...
  fromJSON(object: any): ContextRule {
    return {
      ...
      allowedRequestExtensions: Array.isArray(object?.allowedRequestExtensions)
        ...
        : [],
      allowedResponseExtensions: Array.isArray(object?.allowedResponseExtensions)
