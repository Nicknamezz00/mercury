  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Distribution {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          if (tag === 56) {
            message.bucketCounts.push(longToNumber(reader.int64() as Long));
...
export const Distribution_BucketOptions = {
  ...
  toJSON(message: Distribution_BucketOptions): unknown {
    const obj: any = {};
    message.linearBuckets !== undefined && (obj.linearBuckets = message.linearBuckets
      ? Distribution_BucketOptions_Linear.toJSON(message.linearBuckets)
      : undefined);
    message.exponentialBuckets !== undefined && (obj.exponentialBuckets = message.exponentialBuckets
      ? Distribution_BucketOptions_Exponential.toJSON(message.exponentialBuckets)
      : undefined);
    message.explicitBuckets !== undefined && (obj.explicitBuckets = message.explicitBuckets
...
export const Distribution_BucketOptions_Explicit = {
  ...
  fromJSON(object: any): Distribution_BucketOptions_Explicit {
    return { bounds: Array.isArray(object?.bounds) ? object.bounds.map((e: any) => Number(e)) : [] };
  },
