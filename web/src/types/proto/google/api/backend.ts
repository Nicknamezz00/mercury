...
export const Backend = {
  ...
  fromJSON(object: any): Backend {
    return { rules: Array.isArray(object?.rules) ? object.rules.map((e: any) => BackendRule.fromJSON(e)) : [] };
  },
...
export const BackendRule = {
  encode(message: BackendRule, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.overridesByRequestProtocol).forEach(([key, value]) => {
      BackendRule_OverridesByRequestProtocolEntry.encode({ key: key as any, value }, writer.uint32(82).fork()).ldelim();
    });
    return writer;
  },
...
export const BackendRule_OverridesByRequestProtocolEntry = {
  encode(message: BackendRule_OverridesByRequestProtocolEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BackendRule_OverridesByRequestProtocolEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: BackendRule_OverridesByRequestProtocolEntry): unknown {
    ...
    message.value !== undefined && (obj.value = message.value ? BackendRule.toJSON(message.value) : undefined);
    return obj;
  },
