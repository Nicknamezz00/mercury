...
export const MetricDescriptor = {
  ...
  create(base?: DeepPartial<MetricDescriptor>): MetricDescriptor {
    return MetricDescriptor.fromPartial(base ?? {});
  },
...
export const MetricDescriptor_MetricDescriptorMetadata = {
  ...
  toJSON(message: MetricDescriptor_MetricDescriptorMetadata): unknown {
    ...
    message.samplePeriod !== undefined &&
      (obj.samplePeriod = message.samplePeriod ? Duration.toJSON(message.samplePeriod) : undefined);
    message.ingestDelay !== undefined &&
      (obj.ingestDelay = message.ingestDelay ? Duration.toJSON(message.ingestDelay) : undefined);
    return obj;
  },

  create(base?: DeepPartial<MetricDescriptor_MetricDescriptorMetadata>): MetricDescriptor_MetricDescriptorMetadata {
    return MetricDescriptor_MetricDescriptorMetadata.fromPartial(base ?? {});
  },

  fromPartial(
    object: DeepPartial<MetricDescriptor_MetricDescriptorMetadata>,
  ): MetricDescriptor_MetricDescriptorMetadata {
    const message = createBaseMetricDescriptor_MetricDescriptorMetadata();
    message.launchStage = object.launchStage ?? 0;
    message.samplePeriod = (object.samplePeriod !== undefined && object.samplePeriod !== null)
      ? Duration.fromPartial(object.samplePeriod)
      : undefined;
    message.ingestDelay = (object.ingestDelay !== undefined && object.ingestDelay !== null)
...
export const Metric_LabelsEntry = {
  ...
  create(base?: DeepPartial<Metric_LabelsEntry>): Metric_LabelsEntry {
    return Metric_LabelsEntry.fromPartial(base ?? {});
  },
